...
export default {
  ...
  title: 'Users',
  icon: AiOutlineUser,
  fieldsets: [{ name: 'identifiers', title: 'Related identifiers' }],
  fields: [
    {
      name: 'givenName',
      type: 'string',
    ...
    },
    {
      ...
      options: {
        source: (doc) => `${doc.name}__${doc.privateKey}`,
        maxLength: 96,
      },
      readOnly: true,
    },
    ...
    {
      name: 'lastNotificationsView',
      type: 'datetime',
      title: 'Viewed notifications for the last time',
      readOnly: true,
    ...
    },
    {
      name: 'projects',
      type: 'array',
      title: 'Projects identifiers',
      of: [{ type: 'projectSubscribe' }],
      fieldset: 'identifiers',
      readOnly: true,
    },
    {
    ...
    },
    {
      name: 'notifications',
      type: 'array',
      title: 'Notifications identifiers',
      of: [{ type: 'notificationLike' }],
      fieldset: 'identifiers',
      readOnly: true,
    },
    {
  ...
  preview: {
    ...
    prepare({ givenName = 'No name', familyName, subtitle, avatarUrl }) {
      const imageUrl =
      ...
      return {
        media: <img src={avatarUrl ? avatarUrl : imageUrl} alt={`${givenName} ${familyName}`} />,
